...
<Navbar inverse collapseOnSelect className={classes.navBar}>
  ...
  <Navbar.Collapse>
    <Nav>
      ...
      <NavItem eventKey={2} href="/Testimonial">
        Testimonial
      </NavItem>
  ...
  //   <a className="navbar-brand" href="#">Spraymate</a>
  ...
  //       </li>
  //       <li className="nav-item active">
  //         <a className="nav-link" href="Testimonial">Testimonial <span className="sr-only">(current)</span></a>
  //       </li>
  //       <li className="nav-item active">
